...
class Sam3MultiplexTracking(Sam3MultiplexBase):
    ...
    def _postprocess_output_batched(
        ...
        # ========== Phase 7: Concatenate for batched GPUв†’CPU copy ==========
...
class Sam3MultiplexTrackingProd(Sam3MultiplexTracking):
    ...
    def propagate_in_video(
        ...
        # only a few frames to exit the hotstart buffer вЂ” without this flush
...
class Sam3MultiplexTrackingWithInteractivity(Sam3MultiplexTracking):
    ...
    def add_prompt(
        ...
        if points is not None:
            ...
            # SAM3 prompts вЂ” disable batched grounding for single-frame add_prompt
    ...
    def add_sam2_new_points(
        ...
        if self.rank == obj_rank:
            ...
            # Exclude temp output frames вЂ” preflight will consolidate those
            _temp_frames = set()
