...
class Sam3MultiplexPredictorWrapper(Sam3MultiplexTrackerPredictor):
    ...
    extensive hydra_overrides. This version skips Hydra entirely вЂ” the caller
    ...
    (documented here for reference вЂ” these must be set in model_builder.py):
    ...
    def __init__(
        ...
        # Skip Sam3MultiplexTrackerPredictor.__init__ (requires Hydra) вЂ” call nn.Module.__init__ directly
        nn.Module.__init__(self)
        self.model = model
        self.per_obj_inference = per_obj_inference
        self.fill_hole_area = fill_hole_area
